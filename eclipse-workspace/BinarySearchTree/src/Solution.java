...
*/
          ...
          //  	  System.out.println("Enter an element to be searched: "); 
                 ...
                 bt.search(searchItem);
            	  ...
            	  Node maxItem=null;
            	  if(bt!=null || bt.root!=null || bt.root.equals(null)) {
            		  maxItem = bt.maxNode(bt.root);
            	  }
            	  if(bt==null || maxItem==null) {
            		  output+=" "+"0(0)";
            	  }else {
            		 // output+=" "+maxItem.data;
            		  output+=" "+maxItem.data + "("+maxItem.frequency+") ";
            	  }
            	 // System.out.println("Minimun element in the tree is: "+maxItem); 
            	  
              }else if(input == 4){ // minimun 
            	  Node minItem = bt.minNode(bt.root);//
            	  ...
            	  if(minItem==null) {
            		 ...
            		 // output+=" "+minItem.data;
            		  output+=" "+minItem.data + "("+minItem.frequency+") ";
            	  }
