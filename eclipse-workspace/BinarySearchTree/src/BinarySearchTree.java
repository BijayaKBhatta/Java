...
public class BinarySearchTree {
    ...
    public static class Node{  
      ...
      public Node deleteNode(Node node, int value) {  
          if(node == null){  
              ...
              //If value is equal to node's data that is, we have found the node to be deleted  
                  ...
                  if(node.left == null && node.right == null)  // - 0 child - leaf node 
                      node = null;  
      ...
      public void inorderTraversal(Node node) {  // LNR
          ...
          if(root == null){  
              ...
              if(node.left!= null)  
                  inorderTraversal(node.left);  // recusrsive call left
              System.out.print(node.data + " ");  
              if(node.right!= null)  
                  inorderTraversal(node.right);  // recusrsive call
